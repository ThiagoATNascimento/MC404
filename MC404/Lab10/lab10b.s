...
# a0 = endereço da raiz, a1 = número buscado
recursive_tree_search:
    lw t0, (sp)

    addi sp, sp, -12
    sw ra, 8(sp)    # endereço de retorno
    lw t2, 8(a0)    # \/\/\/\/\/\/\/\/
    sw t2, 4(sp)    # endereço do filho direito   

    li s0, 0        # encontrado
    addi t0, t0, 1  # t0 = profundidade atual

    sw t0, (sp)     # profundidade
